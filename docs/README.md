...
| [referencia-comandos-uci.md](referencia-comandos-uci.md) | Cada comando UCI ya probado: qué hace, qué se envía/responde (bytes reales), y qué significa cada parámetro | Todos |
...
| [ranging-mixto-cli-uci.md](ranging-mixto-cli-uci.md) | Herramienta para ranging real entre una placa UCI (local, USB) y una placa CLI (remota, BLE vía el puente nRF52840): arquitectura de `cli_bridge/`, uso, y resultado real (ranging físico logrado — distancia medida con éxito) | Desarrolladores |
