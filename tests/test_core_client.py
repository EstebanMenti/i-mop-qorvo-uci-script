...
# anterior de 18 parametros (Status.OK, 0 rechazados) -- el formato de esa
# respuesta (status + cantidad de rechazados) no depende de cuantos
# parametros se enviaron, asi que se reutiliza, pero
# **`[Sin confirmar]`** que el firmware acepte tambien los 7 parametros
