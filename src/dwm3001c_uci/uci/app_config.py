...
PARAM_WIDTH_BYTES: dict[int, int] = {
    ...
    AppConfigParam.RSSI_REPORTING: 1,
    ...
    AppConfigParam.UWB_INITIATION_TIME: 8,
    AppConfigParam.HOPPING_MODE: 1,
    AppConfigParam.BLOCK_STRIDE_LENGTH: 1,
    AppConfigParam.RESULT_REPORT_CONFIG: 1,
    AppConfigParam.MAX_NUMBER_OF_MEASUREMENTS: 2,
